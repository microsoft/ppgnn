...
def RunExp(args, dataset, data, Net, percls_trn, val_lb):
	...
	for epoch in range(args.epochs):
		...
		print("Epoch: [{}]	Train Acc: {:.4f}\tVal Loss: {:.4f}\tTest Acc: {:.4f}".format(epoch, train_acc, val_loss, tmp_test_acc))
...
if __name__ == '__main__':
	...
	parser.add_argument('--net', type=str, choices=['GCN', 'GAT', 'APPNP', 'ChebNet', 'JKNet', 'GPRGNN', 'PPGNN'],
						default='GPRGNN')
